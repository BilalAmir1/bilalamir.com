        ...
        <>
            ...
            <div className="hidden lg:flex flex-col items-center justify-center flex-1 relative z-0 mx-4 mt-8">
                ...
                <div className="relative w-full flex items-center h-4">
                    {/* Static track */}
                    <div className="absolute w-full border-t-2 border-zinc-200/80 dark:border-zinc-800/80" />
            ...
            <div className="flex lg:hidden flex-col items-center justify-center w-full relative z-0 my-2 py-4 h-24">
                ...
                <div className="relative h-full flex justify-center w-4">
                    {/* Static track */}
                    <div className="absolute h-full border-l-2 border-zinc-200/80 dark:border-zinc-800/80" />
        ...
        <section id="architecture" className="container">
            <LazyMotion features={domAnimation}>
                ...
                >
                    ...
                    <ArchNode
                        step="02 — Gateway"
                        icon={<Share2 className="w-8 h-8 text-emerald-600 dark:text-emerald-400" />}
                        title="API Layer"
                    ...
                    <ArchNode
                        step="03 — Output"
                        icon={<Layout className="w-8 h-8 text-zinc-700 dark:text-zinc-300" />}
                        title="Presentation"
